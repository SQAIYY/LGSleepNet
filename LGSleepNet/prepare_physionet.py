...
def main():
    ...
    parser.add_argument("--data_dir", type=str, default="../data/physionet_sleep/physionet_sleep/sleep_cassette/",
                        help="File path to the PSG and annotation files.")
    parser.add_argument("--output_dir", type=str, default="../data/output_data/physionet_20/",
